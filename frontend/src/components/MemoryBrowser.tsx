...
function MemoryCard({
  ...
  return (
    <div
      className={cn(
        'industrial-raised border-l-2 bg-[#0a0a10] p-3 transition-colors',
        borderClass,
      )}
    >
      <button
      ...
      {expanded && (
        <div className="mt-3 pt-3 border-t border-[#1a1a22] space-y-2">
...
export function MemoryBrowser({ onClose }: MemoryBrowserProps) {
  ...
  return (
    <div className="flex-1 h-full flex flex-col bg-gradient-to-b from-[#0a0a10] to-[#08080d] relative scanlines">
      ...
      {/* Filter bar */}
      <div className="px-4 py-3 border-b border-[#1a1a22] flex flex-wrap items-center gap-2">
